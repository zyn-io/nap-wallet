...
fn a_padded_anchor_memo_parses_as_an_anchor_and_only_as_an_anchor() {
    let a = Anchor {
        checkpoint: Checkpoint { chain_id: 11, epoch: 3, parent_root: [1; 32], state_root: [2; 32], intent_root: [3; 32], seq: 400, intents: 100, gross_volume: zyn_vm::Fixed::ZERO },
        previous_root: [1; 32],
        epochs: 1,
        actions: 100,
    };
    ...
    assert_eq!(Anchor::parse_memo(&field[..memo::ANCHOR_LEN]), Some((11, 3, a.id())));
